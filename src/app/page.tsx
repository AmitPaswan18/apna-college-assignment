...
export default function LandingPage() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <main className="max-w-7xl w-full px-8 py-8 text-center">
        <div className="flex flex-col items-center">
          ...
          <p className="text-xl md:text-2xl text-slate-400 max-w-2xl mb-12 leading-relaxed">
            The ultimate DSA tracker for top tech interviews. Organize your
            learning, track progress, and conquer the coding world.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-6 mb-24">
            ...
            <Link
              href="#features"
              className="px-10 py-4 rounded-xl bg-white/5 border border-white/10 font-bold hover:bg-white/10 transition-all">
              View Curriculum
            </Link>
          </div>
            ...
            {[
              {
                ...
                desc: "Visual dashboards for easy, medium, and hard problems.",
              },
              {
                icon: Code2,
                title: "Multi-Resource",
                desc: "Direct links to LeetCode, YouTube tutorials, and articles.",
              },
              {
                icon: ShieldCheck,
                title: "Secure & Cloud",
                desc: "Your progress is saved and accessible anywhere.",
              },
            ].map((f, i) => (
              <div
                key={i}
                className="glass-card p-10 group hover:border-primary transition-all">
